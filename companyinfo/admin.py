...
class CarouselAdmin1(admin.ModelAdmin):
    list_display_links = list_display = ['number', 'url','carousel_figure1', 'carousel_figure2', 'carousel_figure3', 'carousel_figure4',
                    'carousel_figure5']
...
class Six_teachAdmin(admin.ModelAdmin):
    list_display_links =list_display = ['title', 'six_teach1', 'six_teach3', 'six_teach5', 'six_teach7', 'six_teach9', 'six_teach11']
...
class AccompanyingAdmin(admin.ModelAdmin):
    list_display_links =list_display = ['title', 'accompany1', 'accompany2', 'accompany3', 'accompany4', 'accompany5', 'accompany6']
...
class ContactAdmin(admin.ModelAdmin):
    list_display_links = list_display = ['title', 'address1', 'address2', 'telephone', 'information', 'contact_number', 'email', 'wechat',
                    'contact_img']
